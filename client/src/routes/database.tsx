...
export default function Database(props: DatabaseProps) {
  ...
  const buttons = [
    { src: "/flora.png", label: "_FLORA//", position: "top-left", route: "/flora" },
    { src: "/fauna.png", label: "_FAUNA//", position: "top-right", route: "/fauna" },
    { src: "/recipes.png", label: "_RICETTE//", position: "bottom-left", route: "/recipes" },
    { src: "/dossier.png", label: "_DOSSIER//", position: "bottom-right", route: "/dossier" },
  ];
