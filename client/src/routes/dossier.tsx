...
export default function Dossier() {
  ...
  const description: string = stateAny?.description || qDesc || (
  ...
  return (
    ...
    >
      <div style={{ width: "min(96vw, 1400px)", margin: "0 auto 80px", position: "relative" }}>
        ...
        <div
          style={{
            ...
            width: "100%",
            minHeight: 300,
            background: "linear-gradient(180deg, rgba(5,16,36,0.75) 0%, rgba(10,30,50,0.65) 100%)",
            boxShadow: "none",
            padding: "22px 26px",
            lineHeight: 1.45,
            letterSpacing: 0.5,
