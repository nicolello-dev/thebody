...
export default function Fauna() {
  ...
  useEffect(() => {
    ...
    const compute = (naturalH: number) => {
      ...
      const overlapPx = naturalH > 0 && density > 1 ? Math.max(0, naturalH - step) : 0;
      if (!cancelled) {
        setDnaImgH(naturalH);
  ...
  return (
    <div className="fauna-page" aria-live="polite">
      ...
      {showNew && (
        <div className={`new-page ${isCollapsing ? "slide-out" : ""}`} role="region" aria-label="Nuova documentazione">
          <div className="fauna-columns-wrapper">
            ...
            <div className="fauna-col-left">
                ...
                {resources.map((res, idx) => {
                  ...
                  return (
                    <div key={idx} className="fauna-item-slot">
                      <img src={itemBg} className="item-bg" alt={itemName || "nessuna risorsa"} />
              ...
              <div className="genome-subtitle" role="heading" aria-level={2} aria-label="Genoma">
                <div className="subtitle-wrapper">
                ...
                <div className="genome-left">
                  <div className="fauna-slots genome-slots">
                    <div className="fauna-slot">
                      ...
                      <span className="slot-value">{String(faunaData.gene?.nome ?? "—").toUpperCase()}</span>
                    </div>
                    <div className="fauna-slot">
                      <img src="/bg-slot.png" className="slot-bg" alt="slot bg" />
                      <span className="slot-label">SORGENTE</span>
                      <span className="slot-value">{String(faunaData.sorgente ?? "—").toUpperCase()}</span>
                    </div>
                  </div>
                  {/* Slot Descrizione sotto gli slot, stessa larghezza (491px) */}
                  <div className="genome-description-container" aria-label="Descrizione gene">
                    <img
                      src="/bg-description.png"
                    ...
                    <div className="genome-detect-wrap">
                      ...
                      <div className="genome-info-overlay" aria-hidden="false">
                        <div className="genome-info genome-prob">
                          {String(faunaData.gene?.probabilitaEstrazione ?? "—").toUpperCase()}
                        </div>
                        <div className="genome-info genome-comp">
                          {String(faunaData.gene?.compatibilita ?? "—").toUpperCase()}
                        </div>
                      </div>
                      ...
                      <div className="genome-reduce-overlay">
                        ...
                        >
                          <div className="reduce-wrapper">
                            <img src="/bg-reduce.png" className="reduce-bg" alt="reduce bg" />
                            <div className="reduce-text">_{faunaData.nome}//</div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="fauna-right-row">
                <div className="stats-block">
                  ...
                  <div className="traits-panel">
                    <img src="/bg-physicaltraits.png" alt="physical traits" className="traits-image" />
            ...
            <div className="dna-stack" aria-hidden style={{ top: DNA_TOP, bottom: DNA_BOTTOM }}>
